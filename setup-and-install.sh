...
LINKS=(
    ...
    "claude_skill_jev_SKILL.md:.claude/skills/jev/SKILL.md"
    "claude_skill_jev_jev.py:.claude/skills/jev/jev.py"
    "claude_skill_jev_router.py:.claude/skills/jev/router.py"
    "claude_agent_jev-tiny.md:.claude/agents/jev-tiny.md"
    "claude_agent_jev-everyday.md:.claude/agents/jev-everyday.md"
    "claude_agent_jev-large.md:.claude/agents/jev-large.md"
    "claude_agent_jev-hardest.md:.claude/agents/jev-hardest.md"
...
CLAUDE_ACCOUNT_LINKS=(
    ...
    "claude_agent_jev-tiny.md:agents/jev-tiny.md"
    "claude_agent_jev-everyday.md:agents/jev-everyday.md"
    "claude_agent_jev-large.md:agents/jev-large.md"
    "claude_agent_jev-hardest.md:agents/jev-hardest.md"
)
